...
// Get any error message stored in the session and clear it afterward
    ...
    <div class="w-full max-w-sm font-serif px-6">
      ...
      <form action="route.php" method="POST" class="space-y-4">
        <div>
          ...
          <input type="text" name="username" required class="w-full p-2 rounded-xl bg-gray-200 focus:outline-none"/>
        </div>
      ...
      <p class="mt-4 text-sm">Already have an account?
        <a href="login.php" class="underline text-black">Login</a>
      </p>
